...
private static final long serialVersionUID = 1L;
	...
	private List <DailyState> dailyStates = new ArrayList<>();

	public Simulation() {}

	public Simulation(String name, Long populationSize, Long initialInfected, Double transmissionFactor,
			Double mortalityRate, Integer recoveryTime, Integer deadTime, Integer durationTime) {
		this.name = name;
	...
	public List<DailyState> getDailyStates() {
		return dailyStates;
	}

	public void setDailyStates(List<DailyState> dailyStatess) {
		this.dailyStates = dailyStatess;
	}
